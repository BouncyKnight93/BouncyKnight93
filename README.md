...
<table border="0" style="border-collapse: collapse; width: 100%;">
  ...
  <tr align="center">
    ...
    <td style="border: none; padding: 6px;"><sub>Scripts</sub></td>
    <td style="border: none; padding: 6px;"><sub>High</sub></td>
  </tr>
    <tr align="center">
    <td style="border: none; padding: 8px;">PowerShell</td>
    <td style="border: none; padding: 6px;"><sub>Scripting & development</sub></td>
    <td style="border: none; padding: 6px;"><sub>Medium</sub></td>
  </tr>
  <tr align="center" style="border: none;">
    <td style="border: none; padding: 8px;">Shell & Batch</td>
    <td style="border: none; padding: 6px;"><sub>System scripting</sub></td>
    <td style="border: none; padding: 6px;"><sub>Medium</sub></td>
  </tr>
  <tr align="center" style="border: none;">
